...
public class RegistroDatos {
    ...
    public String getStrComputadora() {
        return strComputadora;
    }

    public void setStrComputadora(String strComputadora) {
    ...
    public String getStrOperativo() {
        return strOperativo;
    }

    public void setStrOperativo(String strOperativo) {
